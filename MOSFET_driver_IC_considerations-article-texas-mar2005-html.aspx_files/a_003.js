...
if(!self.dartLoadedGlobalTemplates_62_06) {
  self.dartLoadedGlobalTemplates_62_06 = {};
}
if(self.dartLoadedGlobalTemplates_62_06["@GT_TYPE@"]) {
  self.dartLoadedGlobalTemplates_62_06["@GT_TYPE@"].isLoaded = true;
}

function RichMediaCore_62_06() {
...
RichMediaCore_62_06.prototype.isPageLoaded = false;
RichMediaCore_62_06.prototype.csiTimes = new Object();
RichMediaCore_62_06.prototype.setCsiEventsRecordedDuringBreakout = function(creative) {
  if(creative.gtStartLoadingTime != undefined)
    this.csiTimes["gb"] = creative.gtStartLoadingTime;
};
RichMediaCore_62_06.prototype.csiHasValidStart = function(creative) {
  return ((creative.csiAdRespTime >= 0) && (creative.csiAdRespTime < 1e5));
};
RichMediaCore_62_06.prototype.shouldReportCsi = function(creative) {
  
  return this.csiHasValidStart(creative) || (Math.floor(Math.random() * 1001) == 1);
};
RichMediaCore_62_06.prototype.shouldCsi = function(asset, creativeType) {
  switch (creativeType) {
...
RichMediaCore_62_06.prototype.trackCsiEvent = function(event) {
  this.csiTimes[event] = new Date().getTime();
};
RichMediaCore_62_06.prototype.getCsiServer = function() {
...
RichMediaCore_62_06.prototype.reportCsi = function(creative) {
...
RichMediaCore_62_06.prototype._isValidStartTime = function(startTime) {
  return this._isValidNumber(startTime);
};
RichMediaCore_62_06.prototype._convertDuration = function(duration) {
  if(duration) {
...
RichMediaCore_62_06.prototype.convertUnit = function(pos) {
  if(pos != "") {
...
RichMediaCore_62_06.prototype._isValidNumber = function(num) {
  var floatNum = parseFloat(num);
  if(isNaN(floatNum) || floatNum < 0)
    return false;
  return (floatNum == num);
};
RichMediaCore_62_06.prototype.writeSurveyURL = function(creative) {
...
RichMediaCore_62_06.prototype.postPublisherData = function(creative, publisherURL) {
  if(!creative.previewMode && this.isInterstitialCreative(creative) && publisherURL != "") {
    var postImg = new Image();
    postImg.src = publisherURL;
  }
};
RichMediaCore_62_06.prototype.isInterstitialCreative = function(creative) {
...
RichMediaCore_62_06.prototype.isBrowserComplient = function(plugin) {
...
RichMediaCore_62_06.prototype.shouldDisplayFloatingAsset = function(duration) {
  return !this.isInternetExplorer() || this._convertDuration(duration) || this.getIEVersion() >= 5.5;
};
RichMediaCore_62_06.prototype.isWindows = function() {
  return (navigator.appVersion.indexOf("Windows") != -1);
};
RichMediaCore_62_06.prototype.isFirefox = function() {
...
RichMediaCore_62_06.prototype.isSafari = function() {
  var br = "Safari";
...
RichMediaCore_62_06.prototype.isChrome = function() {
  var appUserAgent = navigator.userAgent.toUpperCase();
  var appVendor = (navigator.vendor != undefined) ? navigator.vendor.toUpperCase() : "";
  return (appUserAgent.indexOf("CHROME") != -1) && (appVendor.indexOf("GOOGLE") != -1);
};
RichMediaCore_62_06.prototype.isMac = function() {
  return (navigator.appVersion.indexOf("Mac") != -1);
};
RichMediaCore_62_06.prototype.isInternetExplorer = function() {
  return (navigator.appVersion.indexOf("MSIE") != -1 && navigator.userAgent.indexOf("Opera") < 0);
};
RichMediaCore_62_06.prototype.isIPhone = function() {
  return (navigator.userAgent.toUpperCase().indexOf("IPHONE") != -1);
};
RichMediaCore_62_06.prototype.isIPad = function() {
  return (navigator.userAgent.toUpperCase().indexOf("IPAD") != -1);
};
RichMediaCore_62_06.prototype.isAndroid = function() {
  return (navigator.userAgent.toUpperCase().indexOf("ANDROID") != -1);
};
RichMediaCore_62_06.prototype.getAndroidOSVersion = function() {
...
RichMediaCore_62_06.prototype.getAndroidBrowserVersion = function() {
...
RichMediaCore_62_06.prototype.getIEVersion = function() {
  var version = 0;
...
RichMediaCore_62_06.prototype.getFirefoxVersion = function() {
...
RichMediaCore_62_06.prototype.getSafariVersion = function() {
  var versionIndex = navigator.userAgent.toUpperCase().indexOf("VERSION") + "VERSION".length + 1;
  return parseFloat(navigator.userAgent.substring(versionIndex));
};
RichMediaCore_62_06.prototype.getChromeVersion = function() {
  var versionIndex = navigator.userAgent.toUpperCase().indexOf("CHROME") + "CHROME".length + 1;
  return parseFloat(navigator.userAgent.substring(versionIndex));
};
RichMediaCore_62_06.prototype.isHTML5SupportedBrowser = function() {
   return !!document.createElement('canvas').getContext;
};
RichMediaCore_62_06.prototype.getPluginInfo = function() {
...
RichMediaCore_62_06.prototype._detectNonWindowsFlashPluginVersion = function() {
  var flashVersion = 0;
...
RichMediaCore_62_06.prototype._getIeWindowsFlashPluginVersion = function() {
  var versionStr = "";
  var flashVersion = 0;
...
RichMediaCore_62_06.prototype.trackBackupImageEvent = function(adserverUrl) {
  var activityString = "eid1=9;ecn1=1;etm1=0;";
  var timeStamp = new Date();
  var postImage = document.createElement("IMG");
  postImage.src = adserverUrl + "&timestamp=" + timeStamp.getTime() + ";" + activityString;
};
RichMediaCore_62_06.prototype.trackUrl = function(url, createElement, previewMode) {
  if (previewMode || url == "") {
    return;
  }
  if (createElement) {
...
RichMediaCore_62_06.prototype.logThirdPartyImpression = function(creative) {
  this.trackUrl(creative.thirdPartyImpUrl, false, creative.previewMode);
};
RichMediaCore_62_06.prototype.logThirdPartyBackupImageImpression = function(creative, createElement) {
  this.trackUrl(creative.thirdPartyBackupImpUrl, createElement, creative.previewMode);
};
RichMediaCore_62_06.prototype.logThirdPartyFlashDisplayImpression = function(creative, createElement) {
  this.trackUrl(creative.thirdPartyFlashDisplayUrl, createElement, creative.previewMode);
};
RichMediaCore_62_06.prototype.isPartOfArrayPrototype = function(subject) {
...
RichMediaCore_62_06.prototype.toObject = function(variableName) {
  try {
    if(document.layers) {
...
RichMediaCore_62_06.prototype.getCallbackObjectIndex = function(obj) {
...
RichMediaCore_62_06.prototype.registerPageLoadHandler = function(handler, obj) {
...
RichMediaCore_62_06.prototype.pageLoaded = function() {
  RichMediaCore_62_06.prototype.isPageLoaded = true;
};
RichMediaCore_62_06.prototype.registerPageUnLoadHandler = function(handler, obj) {
  var callback = this.generateGlobalCallback(handler, obj);
...
RichMediaCore_62_06.prototype.registerTimeoutHandler = function(timeout, handler, obj) {
  window.setTimeout(this.generateGlobalCallback(handler, obj), timeout);
};
RichMediaCore_62_06.prototype.createFunction = function(name, ownerObject, args) {
...
RichMediaCore_62_06.prototype.generateGlobalCallback = function(handler, obj) {
  if(obj) {
...
RichMediaCore_62_06.prototype.registerEventHandler = function(event, element, handler, obj) {
  var callback = this.generateGlobalCallback(handler, obj);
  if(this.isInternetExplorer() && this.isWindows()) {
...
RichMediaCore_62_06.prototype.scheduleCallbackOnLoad = function(callback) {
...
RichMediaCore_62_06.prototype.getStyle = function(obj) {
...
RichMediaCore_62_06.prototype.getWindowDimension = function() {
...
RichMediaCore_62_06.prototype.getScrollbarPosition = function() {
...
RichMediaCore_62_06.prototype.isInFriendlyIFrame = function() {
  return this.isWindowAccessible(self.parent);
};
RichMediaCore_62_06.prototype.isWindowAccessible = function(win) {
 try {
  win.document.body;
  return true;
 } catch(e) {
...
RichMediaCore_62_06.prototype.isInMsnFriendlyIFrame = function() {
  return (typeof(inDapIF) != "undefined" && inDapIF);
};
RichMediaCore_62_06.prototype.isInAolFriendlyIFrame = function() {
  return (typeof(inFIF) != "undefined" && inFIF);
};
RichMediaCore_62_06.prototype.isInMsnAjaxEnvironment = function() {
  return (typeof(inDapMgrIf) != "undefined" && inDapMgrIf);
};
RichMediaCore_62_06.prototype.isInYahooFriendlyIFrame = function() {
  return (typeof(isAJAX) != "undefined" && isAJAX);
};
RichMediaCore_62_06.prototype.isInClientPreviewIFrame = function() {
...
RichMediaCore_62_06.prototype.isInAdSenseIFrame = function() {
  return (typeof(IN_ADSENSE_IFRAME) != "undefined") && IN_ADSENSE_IFRAME;
};
RichMediaCore_62_06.prototype.isInWinLiveAPIPlatform = function() {
  try {
...
RichMediaCore_62_06.prototype.isInYahooCrossDomainIframe = function() {
  try {
...
RichMediaCore_62_06.prototype.checkDimension = function(dim) {
...
RichMediaCore_62_06.prototype.setFlashVariable = function(asVersion, flashObject, variableName, value) {
  if (asVersion == 1) {
...
RichMediaCore_62_06.prototype.getFlashVariable = function(asVersion, flashObject, variableName) {
  if (asVersion == 1) {
...
RichMediaCore_62_06.prototype.createExternalInterfaceCallbackAccessor = function(flashObject, methodName) {
...
RichMediaCore_62_06.prototype.getSalign = function(expandedWidth, expandedHeight, offsetTop, offsetLeft, offsetRight, offsetBottom) {
  var salign = "";
...
RichMediaCore_62_06.prototype.usesSalignForExpanding = function(salign, wmode) {
  return ( (this.isMac() && (this.isSafari() || this.isFirefox()))
           || (this.isWindows() && this.isFirefox() && wmode.toLowerCase() == "window") ) && salign.length > 0;
};
RichMediaCore_62_06.prototype.unclipFlashObject = function(asset, width, height, isHTML5) {
  this.clipFlashObject(asset, width, height, "auto", "auto", "auto", "auto", isHTML5);
};


RichMediaCore_62_06.prototype.clipFlashObject = function(asset, width, height, offsetTop, offsetRight, offsetBottom, offsetLeft, isHTML5) {
...
RichMediaCore_62_06.prototype.redrawIE8ForPushdown = function() {
  var bodyStyle = document.body.style.display;
  document.body.style.display = 'block';
  document.body.style.display = bodyStyle;
};
RichMediaCore_62_06.prototype.getSitePageUrl = function(creative) {
...
RichMediaCore_62_06.prototype.getElementPosition = function(obj) {
...
RichMediaCore_62_06.prototype.isFlashObjectReady = function(asVersion, flashObject, assetName) {
  if(asVersion == 1) {
...
RichMediaCore_62_06.prototype.getSiteHost = function(pageUrl) {
  var siteHost = "";
...
RichMediaCore_62_06.prototype.getSiteProtocol = function(pageUrl) {
  var siteProtocol = "";
...
document.write('\n \n              ');
              ...
              richMediaPlcrMap["0"] = new PlcrInfo("plcr_44352888_1317323248805.js", "1317323246193");
              var richMediaPlcrMap_1317323246193 = richMediaPlcrMap;
              var plcrInfo_1317323246193 = richMediaPlcrMap_1317323246193["246753992"];
              if (!plcrInfo_1317323246193) {
                plcrInfo_1317323246193 = richMediaPlcrMap_1317323246193["0"];
              }
              function RichMediaCreative_1317323246193(type) {
                var core = new RichMediaCore_62_06();
                this.creativeIdentifier = "GlobalTemplate_" + "1317323246193" + (new Date()).getTime();
                this.mtfNoFlush = "".toLowerCase();
                this.globalTemplateVersion = "62_06";
                this.isInterstitial = false;
                this.mediaServer = "http://s0.2mdn.net";
                this.adServer = "http://ad.doubleclick.net";
                this.adserverUrl = "http://ad.doubleclick.net/activity;src=1406318;met=1;v=1;pid=15503224;aid=246753992;ko=2;cid=44335101;rid=44352888;rv=1;";
                this.stringPostingUrl = "http://ad.doubleclick.net/activity;src=1406318;stragg=1;v=1;pid=15503224;aid=246753992;ko=2;cid=44335101;rid=44352888;rv=1;rn=4881384;";
                this.swfParams = 'src=1406318&rv=1&rid=44352888';
                this.renderingId = "44352888";
                ...
                this.asContext = (('' != "") ? ('&keywords=' + '') : "")
                                  + (('' != "") ? ('&latitude=' + '') : "")
                                  + (('' != "") ? ('&longitude=' + '') : "");
                this.clickThroughUrl = "http://ad.doubleclick.net/click%3Bh%3Dv8/3bd3/3/0/%2a/k%3B246753992%3B0-0%3B2%3B15503224%3B3454-728/90%3B44335101/44352888/1%3Bu%3D-1%3B%7Esscs%3D%3f";
                this.clickN = "";
                this.type = type;
                this.uniqueId = plcrInfo_1317323246193.uniqueId;
                ...
                this.macro_j = "0-239762408";
                this.macro_eenv = "j";
                this.macro_g = "ct=BD&st=&ac=2&zp=&bw=4&dma=1&city=1037";
                this.macro_s = "hbp.ep";
                this.macro_eaid = "246753992";
                this.macro_n = "4881384";
                this.macro_m = "0";
                this.macro_erid = "44352888";
                this.macro_ebuy = "3342690";
                this.macro_ecid = "44335101";
                this.macro_erv = "1";
                this.macro_epid = "15503224";
                this.macro_eadv = "1406318";
                this.macro_esid = "433243";
                this.macro_ekid = "2";
              }
              eval("RichMediaCreative_"+plcrInfo_1317323246193.uniqueId+" = RichMediaCreative_1317323246193;");
              
document.write('\n          \n                <NOSCRIPT>\n                    <A TARGET=\"_blank\" HREF=\"http://ad.doubleclick.net/activity;src%3D1406318%3Bmet%3D1%3Bv%3D1%3Bpid%3D15503224%3Baid%3D246753992%3Bko%3D2%3Bcid%3D44335101%3Brid%3D44352888%3Brv%3D1%3Bcs%3Dg%3Beid1%3D662402%3Becn1%3D1%3Betm1%3D0%3B_dc_redir%3Durl%3fhttp://ad.doubleclick.net/click%3Bh%3Dv8/3bd3/3/0/%2a/k%3B246753992%3B0-0%3B2%3B15503224%3B3454-728/90%3B44335101/44352888/1%3Bu%3D-1%3B%7Esscs%3D%3fhttp://avnetexpress.avnet.com\">\n                    <IMG SRC=\"http://s0.2mdn.net/1406318/PID_1760798_search_animated_728x90.gif\" width=\"728\" height=\"90\" BORDER=\"0\" alt=\"\">\n                    </A>\n                    <IMG SRC=\"http://ad.doubleclick.net/activity;src=1406318;met=1;v=1;pid=15503224;aid=246753992;ko=2;cid=44335101;rid=44352888;rv=1;&timestamp=4881384;eid1=9;ecn1=1;etm1=0;\" width=\"0px\" height=\"0px\" style=\"visibility:hidden\" BORDER=\"0\"/>\n                    <IMG SRC=\"\" width=\"0px\" height=\"0px\" style=\"visibility:hidden\" BORDER=\"0\"/>\n                    <IMG SRC=\"\" width=\"0px\" height=\"0px\" style=\"visibility:hidden\" BORDER=\"0\"/>\n                </NOSCRIPT>\n                ');

                function generateFixedFlashCode() {
                    var core = new RichMediaCore_62_06();
                    var creative = new RichMediaCreative_1317323246193(core.CREATIVE_TYPE_INPAGE);
                    RichMediaCreative_1317323246193.prototype.csiBaseline = new Date().getTime();
                    RichMediaCreative_1317323246193.prototype.csiAdRespTime =
                        isNaN("") ? -1 : RichMediaCreative_1317323246193.prototype.csiBaseline - parseFloat("");
                    RichMediaCreative_1317323246193.prototype.globalTemplateJs = "http://s0.2mdn.net/879366/inpageGlobalTemplate_v2_62_06"
                        + (creative.debugJSMode ? "_origin" : "" ) + ".js";
                    core.logThirdPartyImpression(creative);
                    if(core.isBrowserComplient(10) ||
                        (creative.isHTML5Creative && core.isHTML5SupportedBrowser())) {
                      RichMediaCreative_1317323246193.prototype.shouldDisplayFlashAsset = !creative.forceHTML5Creative
                          && core.isBrowserComplient(10);
                      if(creative.customScriptFileUrl != "") {
                        document.write('<scr' + 'ipt src="' + creative.customScriptFileUrl + '" language="JavaScript"></scr' + 'ipt>');
                      }
                      var plcrJs = "http://s0.2mdn.net/1406318/" + plcrInfo_1317323246193.filename;
                      RichMediaCore_62_06.prototype.trackCsiEvent("pb");  
                      document.write('<scr' + 'ipt src="' + plcrJs + '" language="JavaScript"></scr' + 'ipt>');
                    }
                    else {
                        var altImgAltText = "";
                        document.write('<A TARGET="_blank" HREF="http://ad.doubleclick.net/activity;src%3D1406318%3Bmet%3D1%3Bv%3D1%3Bpid%3D15503224%3Baid%3D246753992%3Bko%3D2%3Bcid%3D44335101%3Brid%3D44352888%3Brv%3D1%3Bcs%3Dg%3Beid1%3D662402%3Becn1%3D1%3Betm1%3D0%3B_dc_redir%3Durl%3fhttp://ad.doubleclick.net/click%3Bh%3Dv8/3bd3/3/0/%2a/k%3B246753992%3B0-0%3B2%3B15503224%3B3454-728/90%3B44335101/44352888/1%3Bu%3D-1%3B%7Esscs%3D%3fhttp://avnetexpress.avnet.com"><IMG SRC="http://s0.2mdn.net/1406318/PID_1760798_search_animated_728x90.gif" width="728" height="90" BORDER=0 alt="'+ altImgAltText +'"></A>');
                        if(!creative.previewMode) {
